...
public class GeneroController {
    ...
    void AAdd(ActionEvent event) {
		...
		Alert alert = AlertUtil.error("Aviso!", "Aviso!", "Adicionado com sucesso!");
		alert.showAndWait();
    ...
    void AAlterar(ActionEvent event) {
		...
		Alert alert = AlertUtil.error("Aviso!", "Aviso!", "Alterado com sucesso!");
		alert.showAndWait();
    ...
    void ARemover(ActionEvent event) {
		...
		Alert alert = AlertUtil.error("Aviso!", "Aviso!", "Removido com sucesso!");
		alert.showAndWait();
